...
function About({ darkMode }) {
  return (
    <section id="About">
      ...
      <h2 className={`about-heading ${darkMode ? "dark-mode" : "light-mode"}`}>About Me</h2>
      ...
      <p className={`about-p ${darkMode ? "dark-mode" : "light-mode"}`}>
        ...
        <strong>National University of Modern Languages (NUML)</strong>. I have
        a strong interest in <strong>Front-End Web Development</strong> and
      ...
      <p className={`about-p ${darkMode ? "dark-mode" : "light-mode"}`}>
        ...
        <strong>MERN Stack Developer</strong>, and I actively work on enhancing
        my <strong>problem-solving</strong>, <strong>logical thinking</strong>,
        and <strong>collaboration skills</strong>.
      </p>
      <p className={`about-p ${darkMode ? "dark-mode" : "light-mode"}`}>
        I'm always curious, always learning, and always excited to take on new
        challenges - from creating smooth user experiences to writing clean and
        maintainable code.
      </p>
      <h3 className={`about-sub-heading ${darkMode ? "dark-mode" : "light-mode"}`}>🚀 Current Focus:</h3>
      ...
      <p className={`about-p ${darkMode ? "dark-mode" : "light-mode"}`}>
        💡 Whether it's <strong>coding</strong>, <strong>collaborating</strong>,
        or <strong>continuous learning</strong> - I'm always ready to grow!
      </p>
      </div>
    </section>
  );
