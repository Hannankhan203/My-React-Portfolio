  ...
  return (
    ...
    >
      <h1
        style={{ opacity: 0 }}
        ref={headingRef}
        className={`hero-heading ${darkMode ? "dark-mode" : "light-mode"}`}
      >
        Hi, I'm{" "}
      ...
      <p
        style={{ opacity: 0 }}
        ref={paraRef}
        className={`hero-p ${darkMode ? "dark-mode" : "light-mode"}`}
      >
      ...
      >
        <Link
          to="/projects"
          className={`explore-link ${darkMode ? "dark-mode" : "light-mode"}`}
        >
          Explore My Work
        </Link>
      </button>
